...
this.isEditMode = personnel != null;
    ...
    protected void saveForm() {
        ...
        try {
            ...
            Object genderSelection = genderComboBox.getSelectedItem();
            if (genderSelection != null) {
                personnel.setGender((String) genderSelection);
            }
            ...
            if (success) {
                showSuccess("Personnel saved successfully");
                // Publish event for real-time UI updates
                SwingUtilities.invokeLater(() -> {
                    DataChangeBus.publish(PERSONNEL);
                    dispose();
                });
            } else {
